...
#If (KState = 1) and A_PriorHotkey = "vk50" ; П ВЛАЕЗ ; воу-воу, паринь палехче! :)
    vk4F::Send, к ; Г ВЛАЕЗ
#If
#If (KState = 1) and A_PriorHotkey = "vkBE" ; Ш ВЛАЕЗ ; паринь! а ты не охренел ли? XD
    vkBC::Send, т ; Я ВЛАЕЗ
#If
#If (KState = 1) and (A_PriorHotkey = "vk41" || A_PriorHotkey = "vk57") ;  буквы В и Б ВЛАЕЗ ; паринь, ты сошел с ума… :(
    vkDB::Send, ц ; буква Х ЙЦУКЕН, Й ВЛАЕЗ
#If
#If (KState = 1)  and !LeftON and !RightOn
    Tab::Send, ф
    vk51::Send, ж
    vk57::Send, б
    vk45::Send, м 
